...
/**
 * @Author: huangjie
 * @Description :自定义用户为登录返回json数据
 * @Date: Created in 15:15 2018/7/23
 * @Modified By:
 */
public class CustomNotLoginAuthenticationEntryPoint implements AuthenticationEntryPoint {
    private static final Logger logger = LoggerFactory
            .getLogger(CustomNotLoginAuthenticationEntryPoint.class);
     ...
     * URL.
     */
    public CustomNotLoginAuthenticationEntryPoint(String loginFormUrl) {
